...
public class PokerHandTest {
    ...
    class Pairs {
        ...
        void should_return_pair() {
            // given
            var pokerHand = new PokerHand(new Card(FOUR), new Card(FOUR));
        ...
        void should_not_return_pair_when_have_not_pairs() {
            // given
            var pokerHand = new PokerHand(new Card(AS), new Card(FOUR));
        ...
        void should_not_return_pair_when_have_three_of_kind() {
            // given
            var pokerHand = new PokerHand(new Card(FOUR), new Card(FOUR), new Card(FOUR));
